...
| Serviços                     | Fastapi               |                                                                   |                                                                     |                                                             |     |                                          |         |
|                              |                       |                                                                   |                                                                     |                                                             |     |                                          |         |
| Web app (Front + Back)       | .net Core (Blazor)    | Front acoplado, Backend facilmente utilizável como apenas serviço | Mais simples, por precisar hospedar apenas uma instância de serviço |                                                             | ❓   | Menor, por juntar tudo no mesmo ambiente |         |
|                              | Laravel               |                                                                   |                                                                     |                                                             |     |                                          |         |
|                              |                       |                                                                   |                                                                     |                                                             |     |                                          |         |
